...
(3, NULL, 'anujk@gmail.com', 0x3a3a3100000000000000000000000000, '2025-03-20 09:53:49', NULL, 0),
...
CREATE TABLE `pharmacy` (
  `id` int(11) NOT NULL,
  `pharmName` varchar(255) NOT NULL,
  `pharmAddress` text NOT NULL,
  `pharmContact` varchar(15) NOT NULL,
  `pharmEmail` varchar(255) NOT NULL,
  `password` varchar(255) NOT NULL,
...
INSERT INTO `pharmacy` (`id`, `pharmName`, `pharmAddress`, `pharmContact`, `pharmEmail`, `password`, `created_at`, `updated_at`) VALUES
(1, 'City Pharmacy', '123 Main St, Cityville', '1234567890', 'citypharmacy@example.com', '482c811da5d5b4bc6d497ffa98491e38', '2024-03-20 06:30:00', '2024-03-20 06:30:00');
...
INSERT INTO `pharmacylog` (`id`, `uid`, `username`, `userip`, `status`, `logtime`) VALUES
(1, 2, 'healthplus@example.com', '::1', 1, '2025-03-20 17:42:05'),
(2, 2, 'healthplus@example.com', '::1', 1, '2025-03-20 18:13:42'),
(3, NULL, 'healthplus@example.com', '::1', 0, '2025-03-20 19:09:53'),
(4, 1, 'citypharmacy@example.com', '::1', 1, '2025-03-20 19:10:48'),
...
INSERT INTO `prescription_medicines` (`id`, `prescription_id`, `medicine_id`, `quantity_needed`) VALUES
(1, 1, 1, 10),
(2, 2, 1, 10),
(3, 3, 2, 20),
(4, 4, 1, 5),
